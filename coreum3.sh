...
sleep 2
echo export coreum >> $HOME/.bash_profile
echo export wallet >> $HOME/.bash_profile
echo export coreum-testnet-1 >> $HOME/.bash_profile
echo export .core >> $HOME/.bash_profile
echo export v0.1.1 >> $HOME/.bash_profile
echo export utestcore >> $HOME/.bash_profile
echo export cosmovisor >> $HOME/.bash_profile
echo export wallet >> $HOME/.bash_profile
...
cored config node tcp://localhost:52657
